...
*/
module diamond.dom.cssselector;
...
Css3SelectionQuery parseParts(string selector) @safe
{
  ...
  if (currentQuery && currentQuery._parent && !currentQuery._parent._nextSelection)
  {
    currentQuery._parent._nextSelection = currentQuery;
  }
